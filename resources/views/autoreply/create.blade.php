                        ...
                        <div class="card-body">
                            <form action="{{ route('autoreplys.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12 col-12">
                                        <label>Balasan</label>
{{--                                        <input type="text" class="form-control" name="response"  value="{{ old('response') }}" >--}}
                                        <textarea class="form-control" name="response" rows="5">{{ old('response') }}</textarea>
